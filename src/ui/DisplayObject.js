...
function DisplayObject(at,act) {
	...
	m.addToList=function(list,id){
		if(!o.lists)o.lists=[];
		var l=o.lists,i=l.indexOf(list);
		if(i!==-1)l.splice(i,1);
		l.push(list);
		if(id)l[id]=list;
		return o;
	...
	m.syncDisplayTarget=function(){
		var t=o.target;
		if(o!==t){
			var syncp=["transform", "colortransform", "x", "y", "rx", "ry", "sx", "sy", "skx", "sky", "alpha", "visible", "width", "height"],l=syncp.length,p;
			while(l--){
				p=syncp[l];
				o[p]=t[p];
			}
	...
	m.getRoot=function(){
		var l=o.lists,ll=l?l.length:0,r,sr=o.stage?o.stage.root:null;
		if(sr && ll>0 && l.parent){
	...
	m.getX=function(){return o.x;};
	m.getY=function(){return o.y;};
	...
	m.isVisible=function(){
		...
		var l=o.lists,ll=l?l.length:0,r;
		if(ll>0 && l.parent){
	...
	m.updateTransform=function(){
		var cos1,sin1,cos2,sin2,sx=o.sx,sy=o.sy,rx=o.rx,ry=o.ry,skx=o.skx,sky=o.sky,t=o.transform,sktanx,sktany,t0,t1,t2,t3;
		if (ry===0){
			cos1=1;
			sin1=0;
		} else {
	...
	m.transformize=function(a2,b2,c2,d2,e2,f2){
		var t=o.transform,
			a1=t[0],b1=t[1],c1=t[2],d1=t[3],e1=t[4],f1=t[5],
			newt=[];
		newt[0]=a1*a2+c1*b2;
		newt[1]=b1*a2+d1*b2;
		newt[2]=a1*c2+c1*d2;
	...
	m.clone=function(){
		...
		var cloneprops=o.constructor.cloneprops,cl,i,ck;
		c.name=o.name;
		c.x=o.x;
		c.y=o.y;
		c.sx=o.sx;
...
ProtoSS.eventProps(zetaret.global.packages.clockwork.ui.DisplayObject, ["x", "y", "sx", "sy", "rx", "ry", "width", "height", "translate", "scale","rotation", "visible", "transform", "alpha", "colortransform", "target", "lists"]);
ProtoSS.staticProps(zetaret.global.packages.clockwork.ui.DisplayObject, {
	invertTransform: function(tm){
		var n = tm[0]*tm[3]-tm[1]*tm[2], inv=[];
		inv[0] = tm[3]/n;
		inv[1] = -tm[1]/n;
		inv[2] = -tm[2]/n;
		inv[3] = tm[0]/n;
	...
	getUnionBounds: function(ch, tm, transformself, target){
		...
		var chl=ch.length,r=null,rr,rx,ry,rrx,rry,ctm=tm,cho;
		while(chl--){
			cho=ch[chl];
