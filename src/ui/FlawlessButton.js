...
function FlawlessButton() {
	...
	m.renderNormal=function(){
		...
		.drawRoundRect(o.strokeSize, o.strokeSize, w-2*o.strokeSize, h-2*o.strokeSize, o.borderTL-o.strokeSize, o.borderTR-o.strokeSize, o.borderBL-o.strokeSize, o.borderBR-o.strokeSize).stroke()
	...
	m.renderOver=function(){
		...
		.drawRoundRect(o.strokeSize, o.strokeSize, w-2*o.strokeSize, h-2*o.strokeSize, o.borderTL-o.strokeSize, o.borderTR-o.strokeSize, o.borderBL-o.strokeSize, o.borderBR-o.strokeSize).stroke()
		.textStyle(o.overTextColor, o.overTextFont||o.normalTextFont, 1, undefined, "center").text(o.text, Math.round(w/2)+o.textXOffset+o.textOverXOffset, Math.round(h/2)+o.textYOffset+o.textOverYOffset, w);
		var bgs=o.bgshadow;
		bgs.graphics.clear();
		bgs.visible=false;
		o.cacheRedraw=true;
	...
	m.renderDown=function(){
		...
		.drawRoundRect(o.strokeSize, o.strokeSize, w-2*o.strokeSize, h-2*o.strokeSize, o.borderTL-o.strokeSize, o.borderTR-o.strokeSize, o.borderBL-o.strokeSize, o.borderBR-o.strokeSize).stroke()
		.textStyle(o.downTextColor, o.downTextFont||o.normalTextFont, 1, undefined, "center").text(o.text, Math.round(w/2)+o.textXOffset+o.textDownXOffset, Math.round(h/2)+o.textYOffset+o.textDownYOffset, w);
		var bgs=o.bgshadow;
		bgs.alpha=o.shadowAlpha;
		bgs.graphics.clear()
		.dropShadow(o.shadowBlend,o.shadowBlur,o.shadowOffsetX,o.shadowOffsetY,"source-out").beginFill(o.shadowFill,1).drawRoundRect(0, 0, w, h, o.borderTL, o.borderTR, o.borderBL, o.borderBR).endFill();
...
ProtoSS.staticProps(zetaret.global.packages.clockwork.ui.FlawlessButton,{cache:{ids:0}});
