...
function GraphicContext2DMediator() {
	...
	m.configureSetters = function() {
		o.cnvs2drender.setSetters([
			"fillStyle", "strokeStyle", "globalAlpha", "colortransform", "globalCompositeOperation", "imageSmoothingEnabled", "imageSmoothingQuality",
			"shadowColor", "shadowBlur", "shadowOffsetX", "shadowOffsetY",
			"lineWidth", "lineCap", "lineJoin", "miterLimit", "lineDashOffset", "font", "textAlign", "textBaseline", "direction",
			"filter", "currentTransform"
		], true);
	};
	...
	m.setPatternStyle = function(asset, repetition, alpha, matrix, stroke, imgid) {
		...
		if (img) {
			...
			var patid = imgid + repetition,
				pat = c.patternCache[patid] || c.createPattern(img, repetition),
				ct = c.colortransform;
