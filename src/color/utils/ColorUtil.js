window.package("zetaret.global.packages.clockwork.color.utils").internal(
{
	...
	Blend_Alpha:function(blender, base, alpha){
		return new zetaret.global.packages.clockwork.color.RGB(this.Alpha(blender.Red, base.Red, alpha), this.Alpha(blender.Green, base.Green, alpha), this.Alpha(blender.Blue, base.Blue, alpha));
	},
	Blend_Add:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.Add(blender.Red, base.Red), this.Add(blender.Green, base.Green), this.Add(blender.Blue, base.Blue));
	},
	...
	Blend_Average:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.Average(blender.Red, base.Red), this.Average(blender.Green, base.Green), this.Average(blender.Blue, base.Blue));
	},
	Blend_ColorBurn:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.ColorBurn(blender.Red, base.Red), this.ColorBurn(blender.Green, base.Green), this.ColorBurn(blender.Blue, base.Blue));
	},
	Blend_Darken:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.Darken(blender.Red, base.Red), this.Darken(blender.Green, base.Green), this.Darken(blender.Blue, base.Blue));
	},
	Blend_Difference:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.Difference(blender.Red, base.Red), this.Difference(blender.Green, base.Green), this.Difference(blender.Blue, base.Blue));
	},
	Blend_DodgeColor:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.DodgeColor(blender.Red, base.Red), this.DodgeColor(blender.Green, base.Green), this.DodgeColor(blender.Blue, base.Blue));
	},
	Blend_Exclusion:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.Exclusion(blender.Red, base.Red), this.Exclusion(blender.Green, base.Green), this.Exclusion(blender.Blue, base.Blue));
	},
	Blend_Glow:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.Glow(blender.Red, base.Red), this.Glow(blender.Green, base.Green), this.Glow(blender.Blue, base.Blue));
	},
	Blend_HardLight:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.HardLight(blender.Red, base.Red), this.HardLight(blender.Green, base.Green), this.HardLight(blender.Blue, base.Blue));
	},
	Blend_HardMix:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.HardMix(blender.Red, base.Red), this.HardMix(blender.Green, base.Green), this.HardMix(blender.Blue, base.Blue));
	},
	Blend_Lighten:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.Lighten(blender.Red, base.Red), this.Lighten(blender.Green, base.Green), this.Lighten(blender.Blue, base.Blue));
	},
	Blend_LinearBurn:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.LinearBurn(blender.Red, base.Red), this.LinearBurn(blender.Green, base.Green), this.LinearBurn(blender.Blue, base.Blue));
	},
	Blend_LinearDodge:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.LinearDodge(blender.Red, base.Red), this.LinearDodge(blender.Green, base.Green), this.LinearDodge(blender.Blue, base.Blue));
	},
	Blend_LinearLight:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.LinearLight(blender.Red, base.Red), this.LinearLight(blender.Green, base.Green), this.LinearLight(blender.Blue, base.Blue));
	},
	Blend_Multiply:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.Multiply(blender.Red, base.Red), this.Multiply(blender.Green, base.Green), this.Multiply(blender.Blue, base.Blue));
	},
	Blend_Negation:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.Negation(blender.Red, base.Red), this.Negation(blender.Green, base.Green), this.Negation(blender.Blue, base.Blue));
	},
	Blend_Overlay:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.Overlay(blender.Red, base.Red), this.Overlay(blender.Green, base.Green), this.Overlay(blender.Blue, base.Blue));
	},
	Blend_Phoenix:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.Phoenix(blender.Red, base.Red), this.Phoenix(blender.Green, base.Green), this.Phoenix(blender.Blue, base.Blue));
	},
	Blend_PinLight:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.PinLight(blender.Red, base.Red), this.PinLight(blender.Green, base.Green), this.PinLight(blender.Blue, base.Blue));
	},
	Blend_Reflect:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.Reflect(blender.Red, base.Red), this.Reflect(blender.Green, base.Green), this.Reflect(blender.Blue, base.Blue));
	},
	Blend_Screen:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.Screen(blender.Red, base.Red), this.Screen(blender.Green, base.Green), this.Screen(blender.Blue, base.Blue));
	},
	Blend_SoftLight:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.SoftLight(blender.Red, base.Red), this.SoftLight(blender.Green, base.Green), this.SoftLight(blender.Blue, base.Blue));
	},
	Blend_VividLight:function(blender, base){
		return new zetaret.global.packages.clockwork.color.RGB(this.VividLight(blender.Red, base.Red), this.VividLight(blender.Green, base.Green), this.VividLight(blender.Blue, base.Blue));
	},
	...
	Color_Process:function(startColor, endColor, time, alpha){
		...
		var g1=this.GetGreen(startColor);
		var b1=this.GetBlue(startColor);
		var r2=this.GetRed(endColor);
		var g2=this.GetGreen(endColor);
		var b2=this.GetBlue(endColor);
	...
	ColorTransform_Normal:{redMultiplier:1,greenMultiplier:1,blueMultiplier:1,alphaMultiplier:1,redOffset:0,greenOffset:0,blueOffset:0,alphaOffset:0},
	ColorTransform_Darkness:{redMultiplier:1,greenMultiplier:1,blueMultiplier:1,alphaMultiplier:1,redOffset:-255,greenOffset:-255,blueOffset:-255,alphaOffset:0},
	ColorTransform_Lightness:{redMultiplier:1,greenMultiplier:1,blueMultiplier:1,alphaMultiplier:1,redOffset:255,greenOffset:255,blueOffset:255,alphaOffset:0},
	ColorTransform_Inverse:{redMultiplier:-1,greenMultiplier:-1,blueMultiplier:-1,alphaMultiplier:1,redOffset:255,greenOffset:255,blueOffset:255,alphaOffset:0},
	...
	HSB2RGB:function(hue, saturation, brightness){
		...
		var f=hue - hi;
		var p=brightness * (this.ONE - saturation);
		var q=brightness * (this.ONE - f * saturation);
		var t=brightness * (this.ONE - (this.ONE - f) * saturation);
	...
	HSL2RGB:function(hue, saturation, luminosity){
		...
		if (saturation === 0){
			...
			var c=[];
			for (var i=this.ZERO; i < this.THREE; ++i){
				if (t[i] < this.ZERO)
					t[i]=t[i] + this.ONE;
	...
	RGB2HSB:function(red, green, blue){
		...
		var sat;
		var bri;
		var r=this.HexToPercent(red);
		var g=this.HexToPercent(green);
		var b=this.HexToPercent(blue);
