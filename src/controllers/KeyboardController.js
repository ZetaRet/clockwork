...
function KeyboardController() {
	...
	m.addKeyboardEvent=function(type){
		var mtype="keyboardEventHandler_"+type,h=o[mtype]||o.keyboardEventHandler;
	...
	m.stageIterator=function(child, f, customEvent, parent, list, type, childo){
		var stage=o.stage,interc=o.interaction,chi=child[interc.interactIDKey],kim=chi?interc.interactiveVars[chi]:o.defaultInteractiveMap,
			kek=o.keyboardEnabledKey,kck=o.keyboardChildrenKey,kfk=o.keyboardFocusKey;
	...
	m.keyboardEventHandler=function(e){
		var stage=o.stage,keyboardTargets=[],keyboardIterated=[],
	...
	m.getKeys=function(keys,isor){
		var l=keys.length,k,kd=o.keysDown;
		if(isor){
			while(l--){
				k=keys[l];
				if(kd[k])return true;
