...
function AppData() {
	...
	m.initCapabilities = function() {
		...
		o.kpmap = {32: ' ', 111: '/', 106: '*', 109: '-', 110: '.', 107: '+',
			46: '', 35: '', 34: '', 33: '', 36: '', 45: '', 37: '', 38: '', 39: '', 40: '',
	...
	m.detectEnvironment = function() {
		...
		if (!o.capabilities.c2dStrokeTest) CanvasRenderingContext2D.prototype.isPointInStroke = function(x, y) {
			return false;
		};
		return o;
	};
	...
	m.initStage = function(cntxt, cnvscntnr, stagedata) {
		...
		var cc = new zetaret.global.packages.clockwork.context.c2d.Canvas2DRenderer(),
			stage;
