...
ProtoSS.staticProps(zetaret.global.packages.clockwork.graphics.GraphicStroke,{NONE:"none", ROUND:"round", SQUARE:"square", MITER:"miter", BEVEL:"bevel", HORIZONTAL:"horizontal", VERTICAL:"vertical"});
