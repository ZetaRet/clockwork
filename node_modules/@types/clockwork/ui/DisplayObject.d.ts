declare namespace zetaret.global.packages.clockwork.ui {
	export interface DisplayObject {
		...
		new(at?: Array<object>, act?: Array<object>): DisplayObject
		...
		setColorTransform(r: number, g: number, b: number, a: number, ro: number, go: number, bo: number, ao: number): Array<object>
		getColorTransform(): Array<object>
		...
		globalToLocal(x: number, y: number): Array<object>
		localToGlobal(x: number, y: number): Array<object>
		getBounds(tm: Array<object>): object
		...
		render(stage: zetaret.global.packages.clockwork.controllers.Stage2DController, renderer: zetaret.global.packages.clockwork.context.ContextRenderer, ctx: CanvasRenderingContext2D, t: Array<object>, ct: Array<object>): zetaret.global.packages.clockwork.ui.DisplayObject
